   ...
   <el-row :gutter="1" class="el-row">  
      <el-col :span="4" class="el-card">
        <div class="grid-content bg-purple"  >
          <div style="font-size:18px;color:grey ">总人数  </div>
          <br>
      ...
      <el-col :span="4" class="el-card">
        <div class="grid-content bg-purple">
          <div style="font-size:18px;color:grey ">{{dateRange}}注册用户数  </div>
          <br>
        ...
        <el-col :span="4" class="el-card">
        <div class="grid-content bg-purple">
          <div style="font-size:18px;color:grey ">{{dateRange}}消费用户数  </div>
          <br>
          <div style="font-size:40px;text-align:center" >{{newUserCount}}<span style="font-size:20px">人</span></div> 
        </div>
      </el-col>
       ...
       <el-col :span="4" class="el-card">
        <div class="grid-content bg-purple">
          <div style="font-size:18px;color:grey ">{{dateRange}}流失用户数  </div>
          <br>
